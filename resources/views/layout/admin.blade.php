...
<head>
  ...
  <title>馳名天下後台 | @yield('content-header')</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Over</b>TheWorld</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/img/default-profile.png" class="user-image" alt="User Image">
              <span class="hidden-xs">馳名天下管理員</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="/img/default-profile.png" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-bar-chart"></i> <span>球板分析</span>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>@yield('content-header-sub')</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 馳名天下</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017-2017 Ryan Hong</a>.</strong> All rights
    reserved.
  </footer>
